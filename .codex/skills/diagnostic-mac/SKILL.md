...
- Mark the system `READY` if Codex can read and edit project files, run terminal commands, search the web when needed, reach the package registry or download dependencies, run the app, and load the local preview.
